 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Body70 implements ModelInterface, ArrayAccess
{
     ...
     * Sets member_id
     *
     * @param string $member_id Unique Identifier (userId) or email address of the user who will be the new call queue manager.
     *
     * @return $this
     */
