...
class InlineResponse2006 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'messages' => '\Weble\Zoom\Model\InlineResponse2006Messages[]'
    ];
     ...
     * Sets date
     *
     * @param \DateTime $date The date provided in the query parameter. If a date is not provided, the default value is the **current date**.
     *
     * @return $this
     */
     ...
     * Gets messages
     *
     * @return \Weble\Zoom\Model\InlineResponse2006Messages[]
     */
     ...
     * Sets messages
     *
     * @param \Weble\Zoom\Model\InlineResponse2006Messages[] $messages List of message(s).
     *
     * @return $this
     */
