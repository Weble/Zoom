...
class InlineResponse20028 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'page_count' => 'int',
        'page_size' => 'int',
        'participants' => '\Weble\Zoom\Model\InlineResponse20028Participants[]',
        'total_records' => 'int'
    ];
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling InlineResponse20028., must be smaller than or equal to 300.');
        }
     ...
     * Gets participants
     *
     * @return \Weble\Zoom\Model\InlineResponse20028Participants[]
     */
     ...
     * Sets participants
     *
     * @param \Weble\Zoom\Model\InlineResponse20028Participants[] $participants Array of participants.
     *
     * @return $this
     */
