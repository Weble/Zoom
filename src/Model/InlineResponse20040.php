...
class InlineResponse20040 implements ModelInterface, ArrayAccess
{
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling InlineResponse20040., must be smaller than or equal to 300.');
        }
     ...
     * Sets participants
     *
     * @param \Weble\Zoom\Model\InlineResponse20037Participants[] $participants Array of webinar participant objects.
     *
     * @return $this
     */
