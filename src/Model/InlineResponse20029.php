...
class InlineResponse20029 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'to' => '\DateTime',
        'total_records' => 'int',
        'webinars' => '\Weble\Zoom\Model\WebinarMetrics[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['webinars'] = isset($data['webinars']) ? $data['webinars'] : null;
    }
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling InlineResponse20029., must be smaller than or equal to 300.');
        }
     ...
     * Sets webinars
     *
     * @param \Weble\Zoom\Model\WebinarMetrics[] $webinars Array of webinar objects.
     *
     * @return $this
     */
