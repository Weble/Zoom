...
/**
 * InlineResponse20069InMeeting Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20069InMeeting implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_69_in_meeting';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['non_verbal_feedback'] = isset($data['non_verbal_feedback']) ? $data['non_verbal_feedback'] : null;
        $this->container['breakout_room'] = isset($data['breakout_room']) ? $data['breakout_room'] : null;
        $this->container['remote_support'] = isset($data['remote_support']) ? $data['remote_support'] : null;
        ...
        $this->container['show_browser_join_link'] = isset($data['show_browser_join_link']) ? $data['show_browser_join_link'] : null;
     ...
     *
     * @param bool $non_verbal_feedback Allow participants in a meeting can provide nonverbal feedback and express opinions by clicking on icons in the Participants panel.
     *
     * @return $this
     */
     ...
     * Sets remote_support
     *
     * @param bool $remote_support Allow meeting host to provide 1:1 remote support to another participant.
     *
     * @return $this
     */
     ...
     * Sets waiting_room
     *
     * @param bool $waiting_room Attendees cannot join a meeting until a host admits them individually from the waiting room.
     *
     * @return $this
     */
     ...
     *
     * @param bool $show_browser_join_link Allow participants to join a meeting directly from their browser.
     *
     * @return $this
     */
     ...
     *
     * @param bool $custom_data_center_regions Displays whether or not custom [data center regions](https://support.zoom.us/hc/en-us/articles/360042411451-Selecting-data-center-regions-for-hosted-meetings-and-webinars) have been selected for meetings/webinars hosted by this group.
     *
     * @return $this
     */
