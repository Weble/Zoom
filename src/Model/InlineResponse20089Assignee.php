...
/**
 * InlineResponse20089Assignee Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20089Assignee implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_89_assignee';
     ...
     * Sets id
     *
     * @param string $id User ID of the user to whom the device has been assigned.
     *
     * @return $this
     */
     ...
     *
     * @param int $extension_number Extension number of the Zoom Phone used by the user.
     *
     * @return $this
     */
