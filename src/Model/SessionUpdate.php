 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SessionUpdate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SessionUpdate';
     ...
     * Sets type
     *
     * @param int $type Meeting Types:<br>`1` - Instant meeting.<br>`2` - Scheduled meeting.<br>`3` - Recurring meeting with no fixed time.<br>`8` - Recurring meeting with a fixed time.
     *
     * @return $this
     */
     ...
     * Sets start_time
     *
     * @param \DateTime $start_time Meeting start time. When using a format like \"yyyy-MM-dd'T'HH:mm:ss'Z'\", always use GMT time. When using a format like \"yyyy-MM-dd'T'HH:mm:ss\", you should use local time and  specify the time zone. Only used for scheduled meetings and recurring meetings with a fixed time.
     *
     * @return $this
     */
    ...
    public function setPassword($password)
    {
        if (!is_null($password) && (mb_strlen($password) > 10)) {
            throw new \InvalidArgumentException('invalid length for $password when calling SessionUpdate., must be smaller than or equal to 10.');
        }
    ...
    public function setAgenda($agenda)
    {
        if (!is_null($agenda) && (mb_strlen($agenda) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $agenda when calling SessionUpdate., must be smaller than or equal to 2000.');
        }
