...
class PAC implements ModelInterface, ArrayAccess
{
    ...
    public function setParticipantPassword($participant_password)
    {
        if (!is_null($participant_password) && (mb_strlen($participant_password) > 6)) {
            throw new \InvalidArgumentException('invalid length for $participant_password when calling PAC., must be smaller than or equal to 6.');
        }
        if (!is_null($participant_password) && (mb_strlen($participant_password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $participant_password when calling PAC., must be bigger than or equal to 1.');
        }
    ...
    public function setListenOnlyPassword($listen_only_password)
    {
        if (!is_null($listen_only_password) && (mb_strlen($listen_only_password) > 6)) {
            throw new \InvalidArgumentException('invalid length for $listen_only_password when calling PAC., must be smaller than or equal to 6.');
        }
