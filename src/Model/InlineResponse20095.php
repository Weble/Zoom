...
class InlineResponse20095 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'page_size' => 'int',
        'total_records' => 'int',
        'common_area_phones' => '\Weble\Zoom\Model\InlineResponse20095CommonAreaPhones[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['common_area_phones'] = $data['common_area_phones'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['total_records']) && ($this->container['total_records'] > 100)) {
            $invalidProperties[] = "invalid value for 'total_records', must be smaller than or equal to 100.";
        }
     ...
     * Sets page_size
     *
     * @param int $page_size Total number of records returned from a single API call.
     *
     * @return $this
     */
     ...
     * Sets total_records
     *
     * @param int $total_records Total number of records found for this query.
     *
     * @return $this
     */
    public function setTotalRecords($total_records)
    {
        ...
        if (!is_null($total_records) && ($total_records > 100)) {
            throw new \InvalidArgumentException('invalid value for $total_records when calling InlineResponse20095., must be smaller than or equal to 100.');
        }
     ...
     *
     * @return \Weble\Zoom\Model\InlineResponse20095CommonAreaPhones[]
     */
     ...
     *
     * @param \Weble\Zoom\Model\InlineResponse20095CommonAreaPhones[] $common_area_phones common_area_phones
     *
     * @return $this
     */
