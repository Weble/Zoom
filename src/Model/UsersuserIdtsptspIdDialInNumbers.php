...
/**
 * UsersuserIdtsptspIdDialInNumbers Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UsersuserIdtsptspIdDialInNumbers implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'usersuserIdtsptspId_dial_in_numbers';
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $code when calling UsersuserIdtsptspIdDialInNumbers., must be smaller than or equal to 6.');
        }
    ...
    public function setNumber($number)
    {
        if (!is_null($number) && (mb_strlen($number) > 16)) {
            throw new \InvalidArgumentException('invalid length for $number when calling UsersuserIdtsptspIdDialInNumbers., must be smaller than or equal to 16.');
        }
        if (!is_null($number) && (mb_strlen($number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $number when calling UsersuserIdtsptspIdDialInNumbers., must be bigger than or equal to 1.');
        }
     ...
     * Sets type
     *
     * @param string $type Dial-in number types:<br>`toll` - Toll number.<br>`tollfree` -Toll free number.<br>`media_link` - Media Link Phone Number. It is used for PSTN integration instead of paid bridge number.
     *
     * @return $this
     */
    ...
    public function setCountryLabel($country_label)
    {
        if (!is_null($country_label) && (mb_strlen($country_label) > 10)) {
            throw new \InvalidArgumentException('invalid length for $country_label when calling UsersuserIdtsptspIdDialInNumbers., must be smaller than or equal to 10.');
        }
