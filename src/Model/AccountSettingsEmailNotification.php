...
/**
 * AccountSettingsEmailNotification Class Doc Comment
 *
 * @category Class
...
class AccountSettingsEmailNotification implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountSettings_email_notification';
    ...
    protected static $swaggerFormats = [
        'cloud_recording_avaliable_reminder' => null,
        'jbh_reminder' => null,
        'cancel_meeting_reminder' => null,
        'low_host_count_reminder' => null,
    ...
    protected static $setters = [
        'cloud_recording_avaliable_reminder' => 'setCloudRecordingAvaliableReminder',
        'jbh_reminder' => 'setJbhReminder',
        'cancel_meeting_reminder' => 'setCancelMeetingReminder',
        'low_host_count_reminder' => 'setLowHostCountReminder',
    ...
    protected static $getters = [
        'cloud_recording_avaliable_reminder' => 'getCloudRecordingAvaliableReminder',
        'jbh_reminder' => 'getJbhReminder',
        'cancel_meeting_reminder' => 'getCancelMeetingReminder',
        'low_host_count_reminder' => 'getLowHostCountReminder',
    ...
    /**
     * Gets cloud_recording_avaliable_reminder
     *
     * @return bool
     */
    public function getCloudRecordingAvaliableReminder()
    {
        return $this->container['cloud_recording_avaliable_reminder'];
    }

    /**
     * Sets cloud_recording_avaliable_reminder
     *
     * @param bool $cloud_recording_avaliable_reminder Notify host when cloud recording is available.
     *
     * @return $this
     */
    public function setCloudRecordingAvaliableReminder($cloud_recording_avaliable_reminder)
    {
        $this->container['cloud_recording_avaliable_reminder'] = $cloud_recording_avaliable_reminder;
     ...
     * Sets jbh_reminder
     *
     * @param bool $jbh_reminder Notify the host when participants join the meeting before them.
     *
     * @return $this
     */
     ...
     *
     * @param bool $cancel_meeting_reminder Notify the host and participants when a meeting is cancelled.
     *
     * @return $this
     */
    ...
    /**
     * Gets low_host_count_reminder
     *
     * @return bool
     */
    public function getLowHostCountReminder()
    {
        return $this->container['low_host_count_reminder'];
    }

    /**
     * Sets low_host_count_reminder
     *
     * @param bool $low_host_count_reminder Notify user when host licenses are running low.
     *
     * @return $this
     */
    public function setLowHostCountReminder($low_host_count_reminder)
    {
        $this->container['low_host_count_reminder'] = $low_host_count_reminder;
     ...
     *
     * @param bool $alternative_host_reminder Notify when an alternative host is set or removed from a meeting.
     *
     * @return $this
     */
