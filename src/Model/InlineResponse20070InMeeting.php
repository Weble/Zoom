...
/**
 * InlineResponse20070InMeeting Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20070InMeeting implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_70_in_meeting';
     ...
     *
     * @param bool $webinar_question_answer Allow attendees to ask questions for the host and panelists to answer in the webinar.
     *
     * @return $this
     */
     ...
     * Sets dscp_marking
     *
     * @param bool $dscp_marking Enable DSCP marking for signaling and media packets. (Default is 56 for audio, 40 for video, and 40 for signaling.)
     *
     * @return $this
     */
     ...
     *
     * @param bool $custom_data_center_regions Displays whether or not custom [data center regions](https://support.zoom.us/hc/en-us/articles/360042411451-Selecting-data-center-regions-for-hosted-meetings-and-webinars) have been selected for meetings/webinars hosted by the account.
     *
     * @return $this
     */
