...
class InlineResponse2007 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'channels' => '\Weble\Zoom\Model\InlineResponse2007Channels[]'
    ];
     ...
     * Sets page_size
     *
     * @param int $page_size The number of records returned with a single API call. Default value: 30.
     *
     * @return $this
     */
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 100)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling InlineResponse2007., must be smaller than or equal to 100.');
        }
     ...
     * Gets channels
     *
     * @return \Weble\Zoom\Model\InlineResponse2007Channels[]
     */
     ...
     * Sets channels
     *
     * @param \Weble\Zoom\Model\InlineResponse2007Channels[] $channels Chat Channel object(s).
     *
     * @return $this
     */
