...
class AccountList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Account List';
    ...
    protected static $swaggerTypes = [
        'accounts' => '\Weble\Zoom\Model\AccountListAccounts[]',
        'page_count' => 'int',
        'page_number' => 'int',
        'page_size' => 'int',
        'total_records' => 'int'
     ...
     * Gets accounts
     *
     * @return \Weble\Zoom\Model\AccountListAccounts[]
     */
     ...
     * Sets accounts
     *
     * @param \Weble\Zoom\Model\AccountListAccounts[] $accounts List of Account objects.
     *
     * @return $this
     */
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling AccountList., must be smaller than or equal to 300.');
        }
