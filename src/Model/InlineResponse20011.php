...
class InlineResponse20011 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'members' => '\Weble\Zoom\Model\InlineResponse20011Members[]'
    ];
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 100)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling InlineResponse20011., must be smaller than or equal to 100.');
        }
     ...
     * Gets members
     *
     * @return \Weble\Zoom\Model\InlineResponse20011Members[]
     */
     ...
     * Sets members
     *
     * @param \Weble\Zoom\Model\InlineResponse20011Members[] $members Members in a channel.
     *
     * @return $this
     */
