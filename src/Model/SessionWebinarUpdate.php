...
class SessionWebinarUpdate implements ModelInterface, ArrayAccess
{
     ...
     * Sets start_time
     *
     * @param \DateTime $start_time Webinar start time, in the format \"yyyy-MM-dd'T'HH:mm:ss'Z'.\" Should be in GMT time. In the format \"yyyy-MM-dd'T'HH:mm:ss.\" This should be in local time and the timezone should be specified. Only used for scheduled webinars and recurring webinars with a fixed time.
     *
     * @return $this
     */
    ...
    public function setPassword($password)
    {
        if (!is_null($password) && (mb_strlen($password) > 10)) {
            throw new \InvalidArgumentException('invalid length for $password when calling SessionWebinarUpdate., must be smaller than or equal to 10.');
        }
