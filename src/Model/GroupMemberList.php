 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GroupMemberList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Group Member List';
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling GroupMemberList., must be smaller than or equal to 300.');
        }
