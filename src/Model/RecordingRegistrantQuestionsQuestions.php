...
/**
 * RecordingRegistrantQuestionsQuestions Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RecordingRegistrantQuestionsQuestions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Recording Registrant Questions_questions';
     ...
     * Sets required
     *
     * @param bool $required State whether the field is required to be answered by the registrant or not.
     *
     * @return $this
     */
