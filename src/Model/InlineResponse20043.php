...
class InlineResponse20043 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'page_number' => 'int',
        'page_size' => 'int',
        'telephony_usage' => '\Weble\Zoom\Model\InlineResponse20043TelephonyUsage[]',
        'to' => '\\' . \DateTime::class,
        'total_records' => 'int'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['telephony_usage'] = $data['telephony_usage'] ?? null;
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling InlineResponse20043., must be smaller than or equal to 300.');
        }
     ...
     *
     * @return \Weble\Zoom\Model\InlineResponse20043TelephonyUsage[]
     */
     ...
     *
     * @param \Weble\Zoom\Model\InlineResponse20043TelephonyUsage[] $telephony_usage Array of telephony objects.
     *
     * @return $this
     */
