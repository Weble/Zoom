...
class Body72 implements ModelInterface, ArrayAccess
{
     ...
     * Sets name
     *
     * @param string $name Display name of the auto receptionist.
     *
     * @return $this
     */
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Body72., must be smaller than or equal to 32.');
        }
     ...
     *
     * @param int $extension_number Extension number to be assigned to the auto receptionist. If site code is enabled, provide the short extension number instead.
     *
     * @return $this
     */
