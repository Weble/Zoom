...
class AccountSettingsRecordingRecordingPasswordRequirement implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountSettings_recording_recording_password_requirement';
     ...
     * Sets length
     *
     * @param int $length Minimum required length for the password.
     *
     * @return $this
     */
     ...
     * Sets have_letter
     *
     * @param bool $have_letter Indicates whether or not password must contain at least one alphabetical letter (a, b, c..).
     *
     * @return $this
     */
     ...
     * Sets have_number
     *
     * @param bool $have_number Indicates whether or not password must contain at least one number(1, 2, 3..).
     *
     * @return $this
     */
     ...
     *
     * @param bool $have_special_character Indicates whether or not password must contain at least one special character(!, @, #..).
     *
     * @return $this
     */
     ...
     *
     * @param bool $only_allow_numeric Indicates whether or not password must contain only numeric characters.
     *
     * @return $this
     */
