 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TSPAccount1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TSP Account_1';
    ...
    protected static $swaggerTypes = [
        ...
        'leader_pin' => 'string',
        'dial_in_numbers' => '\Weble\Zoom\Model\UsersuserIdtsptspIdDialInNumbers[]',
        'tsp_bridge' => 'string'
    ];
    ...
    public function setConferenceCode($conference_code)
    {
        if ((mb_strlen($conference_code) > 16)) {
            throw new \InvalidArgumentException('invalid length for $conference_code when calling TSPAccount1., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($conference_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $conference_code when calling TSPAccount1., must be bigger than or equal to 1.');
        }
    ...
    public function setLeaderPin($leader_pin)
    {
        if ((mb_strlen($leader_pin) > 16)) {
            throw new \InvalidArgumentException('invalid length for $leader_pin when calling TSPAccount1., must be smaller than or equal to 16.');
        }
        if ((mb_strlen($leader_pin) < 1)) {
            throw new \InvalidArgumentException('invalid length for $leader_pin when calling TSPAccount1., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \Weble\Zoom\Model\UsersuserIdtsptspIdDialInNumbers[]
     */
     ...
     *
     * @param \Weble\Zoom\Model\UsersuserIdtsptspIdDialInNumbers[] $dial_in_numbers List of dial in numbers.
     *
     * @return $this
     */
