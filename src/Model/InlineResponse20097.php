...
class InlineResponse20097 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'page_size' => 'int',
        'total_records' => 'int',
        'blocked_list' => '\Weble\Zoom\Model\InlineResponse20097BlockedList[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['blocked_list'] = $data['blocked_list'] ?? null;
    }
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 100)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling InlineResponse20097., must be smaller than or equal to 100.');
        }
     ...
     * Gets blocked_list
     *
     * @return \Weble\Zoom\Model\InlineResponse20097BlockedList[]
     */
     ...
     * Sets blocked_list
     *
     * @param \Weble\Zoom\Model\InlineResponse20097BlockedList[] $blocked_list blocked_list
     *
     * @return $this
     */
