...
/**
 * InlineResponse20118Settings Class Doc Comment
 *
 * @category Class
...
class InlineResponse20118Settings implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_201_18_settings';
     ...
     * Sets audio
     *
     * @param string $audio Determine how participants can join the audio portion of the webinar.
     *
     * @return $this
     */
     ...
     *
     * @param bool $registrants_confirmation_email Send confirmation email to registrants
     *
     * @return $this
     */
    ...
    public function setRegistrantsRestrictNumber($registrants_restrict_number)
    {
        ...
        if (!is_null($registrants_restrict_number) && ($registrants_restrict_number > 20000)) {
            throw new \InvalidArgumentException('invalid value for $registrants_restrict_number when calling InlineResponse20118Settings., must be smaller than or equal to 20000.');
        }
        if (!is_null($registrants_restrict_number) && ($registrants_restrict_number < 0)) {
            throw new \InvalidArgumentException('invalid value for $registrants_restrict_number when calling InlineResponse20118Settings., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param bool $notify_registrants Send notification email to registrants when the host updates a webinar.
     *
     * @return $this
     */
     ...
     *
     * @param bool $meeting_authentication `true`- Only authenticated users can join Webinar.
     *
     * @return $this
     */
     ...
     *
     * @param string $authentication_option Webinar authentication option id.
     *
     * @return $this
     */
