...
class InlineResponse20033 implements ModelInterface, ArrayAccess
{
     ...
     * Gets issue_details
     *
     * @return \Weble\Zoom\Model\InlineResponse20033IssueDetails[]
     */
    public function getIssueDetails()
    {
        return $this->container['issue_details'];
    }

    /**
     * Sets issue_details
     *
     * @param \Weble\Zoom\Model\InlineResponse20033IssueDetails[] $issue_details issue_details
     *
     * @return $this
     */
    public function setIssueDetails($issue_details)
    {
        $this->container['issue_details'] = $issue_details;
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling InlineResponse20033., must be smaller than or equal to 300.');
        }
