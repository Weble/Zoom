...
/**
 * TheH323SIPDeviceObject_ Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TheH323SIPDeviceObject_ implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'The H.323SIP device object.';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TheH323SIPDeviceObject_., must be smaller than or equal to 64.');
        }
