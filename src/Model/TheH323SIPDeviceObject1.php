...
/**
 * TheH323SIPDeviceObject1 Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TheH323SIPDeviceObject1 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'The H.323SIP device object._1';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TheH323SIPDeviceObject1., must be smaller than or equal to 64.');
        }
