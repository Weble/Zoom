...
class InlineResponse20064Recordings implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_64_recordings';
     ...
     * Sets id
     *
     * @param string $id ID of recording
     *
     * @return $this
     */
     ...
     * Sets duration
     *
     * @param string $duration Duration of the call
     *
     * @return $this
     */
     ...
     * Sets download_url
     *
     * @param string $download_url Download url for the recording. For security purposes, you must provide an OAuth access token in the auth header to download the recording file using this url. <br>  Example request:<br> ``` curl --request GET \\   --url {download_url} \\   --header 'authorization: Bearer {access_token} \\   --header 'content-type: application/json' ```
     *
     * @return $this
     */
     ...
     * Sets date_time
     *
     * @param string $date_time Date and time at which the record is received
     *
     * @return $this
     */
