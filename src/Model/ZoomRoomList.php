 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ZoomRoomList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Zoom Room List';
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling ZoomRoomList., must be smaller than or equal to 300.');
        }
