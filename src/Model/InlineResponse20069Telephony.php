...
/**
 * InlineResponse20069Telephony Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20069Telephony implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_69_telephony';
     ...
     *
     * @param bool $third_party_audio Allow users to join the meeting using the existing 3rd party audio configuration.
     *
     * @return $this
     */
