...
class WebinarSettings implements ModelInterface, ArrayAccess
{
    ...
    public function setRegistrantsRestrictNumber($registrants_restrict_number)
    {
        ...
        if (!is_null($registrants_restrict_number) && ($registrants_restrict_number > 20000)) {
            throw new \InvalidArgumentException('invalid value for $registrants_restrict_number when calling WebinarSettings., must be smaller than or equal to 20000.');
        }
        if (!is_null($registrants_restrict_number) && ($registrants_restrict_number < 0)) {
            throw new \InvalidArgumentException('invalid value for $registrants_restrict_number when calling WebinarSettings., must be bigger than or equal to 0.');
        }
