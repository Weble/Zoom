...
class InlineResponse20021 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'from' => '\DateTime',
        'messages' => '\Weble\Zoom\Model\InlineResponse20021Messages[]',
     ...
     * Gets messages
     *
     * @return \Weble\Zoom\Model\InlineResponse20021Messages[]
     */
     ...
     * Sets messages
     *
     * @param \Weble\Zoom\Model\InlineResponse20021Messages[] $messages Array of session objects.
     *
     * @return $this
     */
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling InlineResponse20021., must be smaller than or equal to 300.');
        }
