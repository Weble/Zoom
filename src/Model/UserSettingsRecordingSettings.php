...
/**
 * UserSettingsRecordingSettings Class Doc Comment
 *
 * @category Class
 * @description
 * @package  Swagger\Client
...
class UserSettingsRecordingSettings implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'User settings Recording settings';
    ...
    public function setAutoDeleteCmrDays($auto_delete_cmr_days)
    {
        ...
        if (!is_null($auto_delete_cmr_days) && ($auto_delete_cmr_days > 60)) {
            throw new \InvalidArgumentException('invalid value for $auto_delete_cmr_days when calling UserSettingsRecordingSettings., must be smaller than or equal to 60.');
        }
        if (!is_null($auto_delete_cmr_days) && ($auto_delete_cmr_days < 1)) {
            throw new \InvalidArgumentException('invalid value for $auto_delete_cmr_days when calling UserSettingsRecordingSettings., must be bigger than or equal to 1.');
        }
