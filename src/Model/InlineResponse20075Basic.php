...
/**
 * InlineResponse20075Basic Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20075Basic implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_75_basic';
     ...
     * Sets support_email
     *
     * @param string $support_email The email address used for reporting Zoom Room issues.
     *
     * @return $this
     */
     ...
     * Sets support_phone
     *
     * @param string $support_phone The phone number used for reporting Zoom room issues.
     *
     * @return $this
     */
     ...
     * Sets room_passcode
     *
     * @param string $room_passcode 1-16 digit number or characters used to secure your Zoom Rooms application. This code must be entered on your Zoom Room Controller to change settings or to sign out.
     *
     * @return $this
     */
    public function setRoomPasscode($room_passcode)
    {
        if (!is_null($room_passcode) && (mb_strlen($room_passcode) > 16)) {
            throw new \InvalidArgumentException('invalid length for $room_passcode when calling InlineResponse20075Basic., must be smaller than or equal to 16.');
        }
        if (!is_null($room_passcode) && (mb_strlen($room_passcode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $room_passcode when calling InlineResponse20075Basic., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param bool $required_code_to_ext Require code to exit out of the Zoom Rooms application to switch between other apps.
     *
     * @return $this
     */
