...
class AccountSettingsFeature implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountSettings_feature';
     ...
     *
     * @param int $meeting_capacity Set the maximum number of participants a host can have in a single meeting.
     *
     * @return $this
     */
