...
/**
 * UsersuserIdmeetingsRecurrence Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UsersuserIdmeetingsRecurrence implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'usersuserIdmeetings_recurrence';
    ...
    public function setEndTimes($end_times)
    {
        ...
        if (!is_null($end_times) && ($end_times > 50)) {
            throw new \InvalidArgumentException('invalid value for $end_times when calling UsersuserIdmeetingsRecurrence., must be smaller than or equal to 50.');
        }
