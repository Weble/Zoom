...
class InlineResponse20046 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'page_size' => 'int',
        'total_records' => 'int',
        'users' => '\Weble\Zoom\Model\InlineResponse20046Users[]'
    ];
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 300)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling InlineResponse20046., must be smaller than or equal to 300.');
        }
     ...
     * Gets users
     *
     * @return \Weble\Zoom\Model\InlineResponse20046Users[]
     */
     ...
     * Sets users
     *
     * @param \Weble\Zoom\Model\InlineResponse20046Users[] $users List of user objects.
     *
     * @return $this
     */
