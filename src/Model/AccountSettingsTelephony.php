...
class AccountSettingsTelephony implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AccountSettings_telephony';
     ...
     *
     * @param bool $third_party_audio Users can join the meeting using the existing third party audio configuration.
     *
     * @return $this
     */
