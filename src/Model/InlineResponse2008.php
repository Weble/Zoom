...
class InlineResponse2008 implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'contacts' => '\Weble\Zoom\Model\InlineResponse2008Contacts[]'
    ];
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 100)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling InlineResponse2008., must be smaller than or equal to 100.');
        }
     ...
     * Gets contacts
     *
     * @return \Weble\Zoom\Model\InlineResponse2008Contacts[]
     */
     ...
     * Sets contacts
     *
     * @param \Weble\Zoom\Model\InlineResponse2008Contacts[] $contacts The contacts object.
     *
     * @return $this
     */
